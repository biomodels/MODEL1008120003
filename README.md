...
`pip install git+https://github.com/biomodels/MODEL1008120003.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1008120003.git@20140916`

## Usage

Importing the model package.

`import MODEL1008120003 as model`
